...
export default function JoinNormalScreen() {
  ...
  const handleJoin = () => {
    ...
    router.push({
      pathname: '/session',
      params: { mode: 'Normal', roomName: code }, // Pass mode and video name
    });
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <KeyboardAvoidingView
        ...
        <View style={styles.content}>
          <IconSymbol name="film" size={60} color="#fff" />
          <Text style={styles.title}>Normalモード</Text>
          <TextInput
            style={styles.input}
            placeholder="動画コードを入力"
          ...
          <TouchableOpacity style={styles.joinButton} onPress={handleJoin}>
            <Text style={styles.joinButtonText}>視聴する</Text>
          </TouchableOpacity>
        </View>
      </KeyboardAvoidingView>
    </SafeAreaView>
